package horstmann.v2ch08.damageReporter;
...
import horstmann.v2ch08.damageReporter.DamageReport.CarType;
...
public class DamageReporterFrame extends JFrame
{
   ...
   private static Map<DamageReport.CarType, Shape> shapes = new EnumMap<CarType, Shape>(
